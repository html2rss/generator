...
require 'html2rss/generator/question'
require 'html2rss/generator/state'
require 'tty-prompt'

RSpec.describe Html2rss::Generator::Question do
  describe '#ask' do
    let(:prompt) { instance_double(TTY::Prompt) }
    let(:state) { instance_double(Html2rss::Generator::State) }
